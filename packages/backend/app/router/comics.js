...
router.post('/favorite', user_controller_1.default.auth, comic_controller_1.default.createFavoriteComic);
router.delete('/favorites/:id', user_controller_1.default.auth, comic_controller_1.default.deleteFavoriteComic);
router.get('/favorites', user_controller_1.default.auth, comic_controller_1.default.getFavoriteComics);
router.get('/favorites/:id', user_controller_1.default.auth, comic_controller_1.default.getFavoriteComic);
...
router.post('/comics/:id/:chapter', upload.array('images'), comic_controller_1.default.createComicChapter);
