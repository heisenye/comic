...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.login = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, pwd, user, _b, salt, storedHash, hash, token, createdAt, id, error_2;
    ...
    UserController.prototype.profile = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var id, user, username, createdAt, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        ctx.body = response_1.default.Success({
                            data: { id: id, username: username, createdAt: new Date(createdAt).toLocaleDateString() }
                        });
                        return [3 /*break*/, 3];
                    case 2:
                        error_4 = _a.sent();
    ...
    UserController.prototype.uploadAvatar = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var id, buffer, newFilename, directoryPath, filePath, user, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    UserController.prototype.auth = function (ctx, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        token = String(ctx.header.authorization).split(' ')[1];
                        if (!token) {
                            ctx.response.status = status_1.ResponseCode.Unauthorized;
