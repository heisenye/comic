...
var ComicController = /** @class */ (function () {
        ...
        switch (_a.label) {
          ...
          case 3:
            ...
            orderedHistoryComics = ids
              .map(function (id) {
                return unorderedHistoryComics_1.find(function (comic) {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (
              ...
              !mongoose_1.default.Types.ObjectId.isValid(comicId)
            ) {
              ctx.response.status = status_1.ResponseCode.Bad_Request
              ctx.body = response_1.default.InValidId()
              return [2 /*return*/]
  ...
  ComicController.prototype.setComicCover = function (ctx) {
    return __awaiter(this, void 0, void 0, function () {
      var id, _a, chapter, page, comic, result, error_13
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            _b.trys.push([0, 3, , 4])
          ...
          case 3:
            error_13 = _b.sent()
            ctx.response.status = status_1.ResponseCode.Internal_Server_Error
            response_1.default.UnknownError(error_13)
            return [3 /*break*/, 4]
          case 4:
            return [2 /*return*/]
        }
